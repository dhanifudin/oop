...
def rows_p14():
    return [
        (p13("langkah-01"), "Bank.java", p14("langkah-01"), "Bank.java",
         "p14-01-bank-nextaccountnumber", [(1, 3), (32, 45)]),
        (None, None, p14("langkah-01"), "ui/BankMiniFrame.java", "p14-01-bankminiframe-fields",
         [(1, 40)]),
        (None, None, p14("langkah-01"), "ui/BankMiniFrame.java", "p14-01-bankminiframe-addaccounthandler",
         [(1, 3), (110, 113)]),
        (None, None, p14("langkah-01"), "ui/AddAccountDialog.java", "p14-01-addaccountdialog-constructor",
         [(1, 21)]),
        (None, None, p14("langkah-01"), "ui/AddAccountDialog.java", "p14-01-addaccountdialog-savehandler",
         [(1, 3), (110, 142)]),
        (None, None, p14("langkah-02"), "ui/BankMiniFrame.java", "p14-02-selectionlistener",
         [(1, 3), (44, 50)]),
...
def rows_p15():
    return [
        ...
        (p14("langkah-02"), "Bank.java", p15("langkah-01"), "Bank.java",
         "p15-01-bank-saveaccount", [(1, 10), (47, 49)]),
        (p14("langkah-02"), "Bank.java", p15("langkah-01"), "Bank.java",
         "p15-01-bank-processmonthend", [(1, 3), (63, 72)]),
        (p14("langkah-02"), "ui/BankMiniFrame.java", p15("langkah-01"), "ui/BankMiniFrame.java",
         "p15-01-bankminiframe-constructor", [(1, 9), (15, 32)]),
        (p14("langkah-02"), "ui/BankMiniFrame.java", p15("langkah-01"), "ui/BankMiniFrame.java",
         "p15-01-bankminiframe-savecalls", [(1, 3), (154, 204)]),
        ...
        (p15("langkah-01"), "ui/BankMiniFrame.java", p15("tugas"), "ui/BankMiniFrame.java",
         "p15-tugas-bankminiframe-constructor", [(1, 9), (15, 22)]),
